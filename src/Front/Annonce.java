...
public class Annonce {
    ...
    public Annonce (int id, String Title, String Location, String Description, String StartDate, String EndDate, String Fonction) {
    	this.id = id;
    	this.title = Title;
    ...
    }// Créé juste pour tester la fct du serveur 
    public Annonce(int id, String title, String location, String description, String startDate, String endDate,
                   ...
                   String contracDetails, String url, String siteName, String adresseEntreprise, String siteWebEntreprise,
                   String nomEntreprise, String descriptionEntreprise, String region, String city, String industry,
                   String traitsPersonnalite, String competencesRequises, String softSkills, String competencesRecommandees,
                   String langue, String niveauLangue, String salaire, String avantagesSociaux, String teletravail) {
        this.id = id;
        this.title = title;
        this.location = location;
        this.description = description;
    ...
    public Annonce(Annonce a) {
        ...
        this.contracDetails = a.contracDetails;
        this.url = a.url;
